...
#define SERVER_URL "http://SERVER_IP:9003/api/v1/stream/stream"
#define REGISTER_URL "http://SERVER_IP:9003/api/v1/devices/register"
#define HEARTBEAT_URL "http://SERVER_IP:9003/api/v1/devices/heartbeat"
