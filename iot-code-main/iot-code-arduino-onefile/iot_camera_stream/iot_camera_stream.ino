...
const char* server_url = "http://SERVER_IP:9005/api/v1/stream/stream";
const char* register_url = "http://SERVER_IP:9005/api/v1/devices/register";
const char* heartbeat_url = "http://SERVER_IP:9005/api/v1/devices/heartbeat";
